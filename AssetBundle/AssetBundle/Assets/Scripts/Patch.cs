...
public class Patch : MonoBehaviour
{
    ...
    {
        string url = $"file:///{Application.dataPath}/PatchInfo/{_name}";   //경로를 설정해준다
        Debug.Log(url); //출력
        UnityWebRequest www = UnityWebRequestAssetBundle.GetAssetBundle(url);   //경로로부터 에셋번들을 받아서 www에 넣어준다
